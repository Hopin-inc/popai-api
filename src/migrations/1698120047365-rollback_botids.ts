...
export class rollbackBotids1698120047365 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `s_implemented_chat_tools` CHANGE COLUMN `channel_bot_secret` `bot_secret` TEXT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `s_implemented_chat_tools` CHANGE COLUMN `bot_secret` `channel_bot_secret` varchar(50) NULL");
