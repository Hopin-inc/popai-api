...
export class implementSlack1674107001186 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_e7566dddb9af62f46aeec4bbd3\` ON \`section_labels\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_e7566dddb9af62f46aeec4bbd3\` ON \`section_labels\` (\`section_id\`)`);
    }
