...
export class addSlackBotInfoInIct1678942674374 implements MigrationInterface {
    name = 'addSlackBotInfoInIct1678942674374'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`s_implemented_chat_tools\` ADD \`registered_app_user_id\` varchar(12) COLLATE "utf8mb4_unicode_ci" NULL`);
