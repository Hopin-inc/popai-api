...
export class addTablesForSetting1677656400973 implements MigrationInterface {
    name = 'addTablesForSetting1677656400973'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`s_daily_report_timings\` (\`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime NULL ON UPDATE CURRENT_TIMESTAMP, \`deleted_at\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`config_id\` int NOT NULL, \`time\` time NOT NULL, \`enable_pending\` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX \`REL_9081b3ca4c4e2397827b4acb71\` (\`config_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`s_prospect_timings\` (\`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime NULL ON UPDATE CURRENT_TIMESTAMP, \`deleted_at\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`config_id\` int NOT NULL, \`time\` time NOT NULL, \`ask_plan\` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX \`REL_e930c06d89a86c5a12b7d58ef9\` (\`config_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`REL_e930c06d89a86c5a12b7d58ef9\` ON \`s_prospect_timings\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_9081b3ca4c4e2397827b4acb71\` ON \`s_daily_report_timings\``);
